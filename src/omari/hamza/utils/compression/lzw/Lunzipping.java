...
public class Lunzipping {
    ...
    public static void Lunzip(String source, String destination) {
        int k;
        int dictSize = 256;
        int mpsz = 256;
        String ts;
        ...
        String fileos = source.substring(0, source.length() - 6);

        File filei = null, fileo = null;
        filei = new File(source);
    ...
    public static void beginLunzipping(String arg1, String arg2) {
        big1 = "";
        bitsz1 = 0;
        pre();
        Lunzip(arg1, arg2);
